...
if (isset($_POST['insertInfo'])) {
    ...
    $sql = "INSERT INTO information VALUES(null,'$info_name','$info_content','$info_owner',now())";
        ...
        <form action="_information_create.php" method="post">
            ...
            <div class="card-body">
                <div class="row">
                    ...
                    <div class="col-sm-6 col-md-6 col-lg-6">
                        <input type="text" style="font-size: 100%;" id="info_name" name="info_name" class="form-control"
                               required>
                    </div>
                </div>
                <div class="row">
                    ...
                    <div class="col-sm-6 col-md-6 col-lg-6" style="cursor: pointer;">
                        ...
                        <textarea class="form-control" rows="15" onkeyup="preview()" name="comment" id="comment"
                                  style="font-size: 100%;" required></textarea>
                    </div>
                </div>
                <hr>
                <div class="row">
            ...
            <div class="card-footer">
                <div class="row">
                    ...
                    <div class="col-sm-6 col-md-6 col-lg-6">
                        <button type="submit" class="btn btn-success" name="insertInfo"><i class="material-icons">note_add</i>เพิ่มหัวข้อ
                        </button>
                    </div>
                </div>
            </div>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <button type="button" onclick="addLink('a')" data-dismiss="modal" class="btn btn-outline-info"
                        style="font-size: 100%;"><i class="fa fa-plus"></i> เพิ่มลิ้งค์
                </button>
            </div>

            <!-- Modal footer -->
            <div class="modal-footer">
                <button type="button" class="btn btn-danger" data-dismiss="modal" style="font-size: 100%;"><i
                            class="fa fa-times"></i> ปิด
                </button>
            </div>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <button type="button" onclick="addLink('img')" data-dismiss="modal" class="btn btn-outline-primary"
                        style="font-size: 100%;"><i class="fa fa-plus"></i> เพิ่ม
                </button>
            </div>
